...
// TODO: documentation
struct _InitRet init_perfect(int h, int leftmost_id, void **ids, struct List *users) {
...
struct _InitRet root_init(int n, int leftmost_id, void **ids, struct List *users){
  struct _InitRet ret = { NULL, NULL };
